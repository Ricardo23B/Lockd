#!/usr/bin/env python3
"""
lockd/entry.py — punto de entrada unificado de Lockd
...
from lockd import __version__ as APP_VERSION
...
def run_gui():
    ...
    class LockdApp(Adw.Application):
        ...
        def do_activate(self):
            ...
            from lockd.interfaces.gui.main_window import MainWindow
...
def run_cli():
    ...
    from lockd.interfaces.cli.main import run
